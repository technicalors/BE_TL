...
Route::group([
    ...
    $router->get('/test-api/{deviceID}', [Phase2OIApiController::class, 'fetchDataFromApi']);
});
...
Route::group([
    ...
    $router->post('product/import-product-and-customer', [App\Admin\Controllers\ProductController::class, 'importProductAndCustomer']);
...
Route::group([
    ...
    $router->post('reprint-tem', [Phase2OIApiController::class, 'reprintTem']);
...
Route::group([
    ...
    $router->get('quality/pqc/export-pqc-report', [Phase2UIApiController::class, 'exportPQCReportV2']);
    ...
    $router->get('kpi/tong-don-hang', [Phase2UIApiController::class, 'getKPIOrderProductionByProduct']);
