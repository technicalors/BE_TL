    ...
    private function machineErrorTable($mark_err, $machine_log)
    {
        ...
        foreach ($machine_log as $log) {
            ...
            $tm = [
                ...
                "thoi_gian_bat_dau_dung" => Carbon::parse($log->info['start_time'], 'Asia/Ho_Chi_Minh')->format("d/m/Y H:i:s"),
                "thoi_gian_ket_thuc_dung" => isset($log->info['end_time']) ? Carbon::parse($log->info['end_time'], 'Asia/Ho_Chi_Minh')->format("d/m/Y H:i:s") : "",
                "lo_sx" => $lo_sx,
                "lot_id" => $lot_id,
                "thoi_gian_dung" => $d,
                "error_id" => $err->code ?? "",
