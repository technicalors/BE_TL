...
class Phase2OIApiController extends Controller
{
    ...
    public function scanForProductionLine(Request $request)
    {
        ...
        if (!$current_plan->pass_input_lot_id && $current_plan->product_id !== 'RD176' && $current_plan->product_id !== 'RD276' && $current_plan->product_id !== 'SSG186' && $current_plan->product_id !== 'RD476') {
