...
class InfoCongDoan extends Model
{
    ...
    {
        $latestInfo = InfoCongDoan::where('lo_sx', $lo_sx)->where('line_id', $line_id)->orderBy('id', 'DESC')->first();
    ...
    {
        return $this->hasMany(Assignment::class, 'lot_id', 'lot_id');
    }
